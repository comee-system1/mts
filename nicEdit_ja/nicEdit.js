...
var nicLinkButton = nicEditorAdvancedButton.extend({	
	addPane : function() {
		...
		this.addForm({
			'' : {type : 'title', txt : 'リンクを追加',style:{color:'#000000'}},
			'href' : {type : 'text', txt : 'URL', value : 'http://', style : {width: '150px',color:'#000000'}},
			'title' : {type : 'text', txt : 'タイトル', style : {width: '150px',color:'#000000'}},
			'target' : {type : 'select', txt : 'ウィンドウ', options : {'' : '同じウィンドウで開く', '_blank' : '新しいウィンドウで開く'},style : {width : '150px',color:'#000000'}}
		},this.ln);
	},
